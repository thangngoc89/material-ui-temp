...
var styleSheet = exports.styleSheet = (0, _createStyleSheet2.default)('MuiDrawer', function (theme) {
  return {
    paper: {
      overflowY: 'auto',
      display: 'flex',
  ...
  (0, _createClass3.default)(Drawer, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          theme = _props.theme,
          other = (0, _objectWithoutProperties3.default)(_props, ['anchor', 'children', 'classes', 'className', 'docked', 'enterTransitionDuration', 'leaveTransitionDuration', 'elevation', 'open', 'SlideProps', 'theme']);
      ...
      if (docked) {
        var _onRequestClose = other.onRequestClose,
            otherDocked = (0, _objectWithoutProperties3.default)(other, ['onRequestClose']);


        return _react2.default.createElement(
          'div',
          (0, _extends3.default)({ className: (0, _classnames2.default)(classes.docked, className) }, otherDocked),
          drawer
        );
      }
...
exports.default = (0, _withStyles2.default)(styleSheet, { withTheme: true })(Drawer);