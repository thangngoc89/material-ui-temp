...
var styleSheet = exports.styleSheet = (0, _createStyleSheet2.default)('MuiModal', function (theme) {
  return {
    root: {
      display: 'flex',
      width: '100%',
